    ...
    hspec $ do
      describe "ls" $ do
        it "should return files and dirs with full path" $ do
          "flat" ^! ls `shouldReturn` ["flat/file.txt","flat/file.md"]
        it "should allow traversing deeper" $ do
          "flat" ^!! ls . traversed `shouldReturn` ["flat/file.txt","flat/file.md"]
      describe "ls'ed" $ do
        it "should behave like 'ls' but with traversal" $ do
          "flat" ^!! ls'ed `shouldReturn` ["flat/file.txt","flat/file.md"]
      describe "path" $ do
      ...
      describe "dirs" $ do
        it "should filter to only dirs" $ do
          "flat" ^!! ls . traversed . dirs `shouldReturn` mempty
      describe "files" $ do
      ...
      describe "exts" $ do
        it "should filter by extension" $ do
          "flat" ^!! ls . traversed . exts ["", "txt"] `shouldReturn` ["flat/file.txt"]
      describe "crawled" $ do
